            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-4 custom-scrollbar">
                {cart.length === 0 ? (
                  ...
                  cart.map((item) => (
                    <div key={item.id} className="flex items-center gap-4 bg-white/5 border border-white/10 p-4 rounded-xl group hover:bg-white/10 transition-colors">
                      <img src={item.image} alt={item.name} className="w-20 h-20 object-cover rounded-lg shadow-md" />
                      
                      <div className="flex-1">
                        <h3 className="text-white font-semibold line-clamp-1 group-hover:text-brand-cyan transition-colors">{item.name}</h3>
                        <p className="text-brand-cyan font-bold">{item.price}</p>
                      </div>

                      <div className="flex items-center gap-3 bg-slate-950/50 rounded-full px-3 py-1 border border-white/5">
                        <button 
                      ...
                      <button 
                        ...
                        className="text-red-400 hover:text-red-300 transition-colors p-2 rounded-full hover:bg-red-400/10 ml-2"
                      >
                ...
                <div className="p-6 border-t border-white/10 bg-slate-950/50">
                  ...
                  <div className="flex gap-4">
                    ...
                    <button 
                      ...
                      className="flex-1 py-3 px-4 rounded-xl font-bold text-slate-950 bg-brand-cyan shadow-[0_0_15px_rgba(0,240,255,0.4)] hover:shadow-[0_0_25px_rgba(0,240,255,0.6)] transition-shadow"
                    >
                      Checkout
                    </button>
                  </div>
